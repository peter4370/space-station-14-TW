book-text-atmos-distro = 分配網路（簡稱「distro」）是該站的生命線。它負責將大氣中的空氣輸送至站內各處。
...
book-text-atmos-waste = 廢氣網絡是負責維持太空站空氣無污染的主要系統。
...
book-text-atmos-alarms = 各站內均設置有空氣警報器，以便管理與監控當地大氣狀況。
