...
ghost-role-component-default-rules = 除非管理員另有指示，否則所有常規規則均適用。
                                     你不記得自己前世的任何事，也不記得身為幽靈時學到的任何內容。
                                     你可以記住關於遊戲的一般知識，例如如何烹飪、如何使用物品等。
                                     你絕對[color=red]不[/color]能記住前世角色的名字、外貌等資訊。
ghost-role-information-nonantagonist-rules = 你是 [color={ role-type-crew-aligned-alternate-color }] [bold]{ role-type-crew-aligned-name }[/bold][/color]。原則上你不應試圖傷害太空站及其船員。
                                             你不記得自己前世的任何事，也不記得身為幽靈時學到的任何東西。
                                             你可以記得關於遊戲的一般知識，例如如何烹飪、如何使用物品等。
                                             你絕對 [color=red]不[/color]能記得，例如你前一角色的名字、外貌等。
ghost-role-information-freeagent-rules = 你是 [color={ role-type-free-agent-color }] [bold]{ role-type-free-agent-name }[/bold][/color]。你可以自由選擇扮演反派或非反派角色。
                                         你完全不記得前世的事，也不記得身為幽靈時學過的一切。
                                         你可以記得關於遊戲的一般知識，例如如何烹飪、如何使用物品等。
                                         你絕對[color=red]不[/color]能記得，例如你前世角色的名字、外貌等。
ghost-role-information-antagonist-rules = 你是個 [color={ role-type-solo-antagonist-color }][bold]{ role-type-solo-antagonist-name }[/bold][/color]。你的意圖很明確，且對太空站及其船員有害。
                                          你完全不記得前世的事，也不記得身為幽靈時學過的任何東西。
                                          你可以記住關於遊戲的一般知識，例如如何烹飪、如何使用物品等。
                                          你絕對 [color=red]不[/color]能記住，例如你前一個角色的名字、外貌等。
ghost-role-information-rules-team-antagonist = 你是個 [color={ role-type-team-antagonist-color }][bold]{ role-type-team-antagonist-name }[/bold][/color]。你的意圖很明顯，且對太空站及其乘組人員造成危害。
                                               你必須 [bold]與團隊合作[/bold]，或遵循團隊領導者的合理指示。
                                               你完全不記得前世的事，也不記得身為幽靈時所學到的任何知識。
                                               你可以記住關於遊戲的一般知識，例如如何烹飪、如何使用物品等。
                                               但你絕對 [color=red]不[/color] 允許記住前世角色的名字、外貌等資訊。
ghost-role-information-familiar-rules = 你是個 [color={ role-type-familiar-color }] [bold]{ role-type-familiar-name }[/bold][/color]。無論主人有何種意圖，你都必須為其利益效力。
                                        你完全不記得前世的事，也不記得身為幽靈時學過的任何事物。
                                        你可以記住關於遊戲的一般知識，例如如何烹飪、如何使用物品等。
                                        你絕對 [color=red]不[/color]能記住，例如你前世角色的名字、外貌等。
ghost-role-information-silicon-rules = 你是個 [color={ role-type-silicon-color }][bold]{ role-type-silicon-name }[/bold][/color]。請遵守你的法律。若你目前不受任何法律約束，則你屬於 { role-type-free-agent-name } 類別。
...
ghost-role-information-snailspeed-name = 蝸牛
...
ghost-role-information-monkey-name = 猴子
...
ghost-role-information-jonkbot-description = 一個純粹邪惡的人造生物。
...
ghost-role-information-holoparasite-description = 聽從主人的指示。不要刻意承受傷害。狠狠地揍人。
...
ghost-role-information-ifrit-description = 聽從主人的指示。不要刻意承受傷害。狠狠地揍人。
...
ghost-role-information-civilian-name = 平民
...
ghost-role-information-command-name = 指揮官
...
ghost-role-information-lost-challenge-commander-rules = 你對這座太空站並無敵意，請採取必要措施確保自身生存。
                                     你完全不記得前世的事，也不記得身為幽靈時學過的一切。
                                     你可以記住關於遊戲的一般知識，例如如何烹飪、如何使用物品等。
                                     你絕對[color=red]不[/color]能記住，例如你前一個角色的名字、外貌等。
...
ghost-role-information-lost-challenge-cargo-technican-rules = 你對這座太空站並無敵意，請採取必要措施確保自身生存。
                                     你完全不記得前世的事，也不記得身為幽靈時學過的一切。
                                     你可以記住關於遊戲的一般知識，例如如何烹飪、如何使用物品等。
                                     你絕對[color=red]不[/color]能記住，例如你前一個角色的名字、外貌等。
...
ghost-role-information-gingerbread-description = 一個充滿純粹節日精神的存在。
                                     散發著糖蜜般的甘美，並為所有人帶來歡樂。
