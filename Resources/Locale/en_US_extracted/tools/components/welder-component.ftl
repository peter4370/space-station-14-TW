welder-component-welder-not-lit-message = The { $owner } is turned off!
welder-component-cannot-weld-message = The { $owner } does not have enough fuel for that!
welder-component-no-fuel-message = The { $owner } has no fuel left!
welder-component-no-fuel-in-tank = The { $target } is empty.
...
welder-component-already-full = The { $owner } is already full.
