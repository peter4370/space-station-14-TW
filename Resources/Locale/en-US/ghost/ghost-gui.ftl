...
ghost-gui-toggle-lighting-manager-popup-normal = 普通光線。
ghost-gui-toggle-lighting-manager-popup-half-bright = 半明。
ghost-gui-toggle-lighting-manager-popup-fullbright = 富布賴特。
...
ghost-target-window-warp-to-title = [粗體]快速傳送[/粗體]
